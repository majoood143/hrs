                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{ route('admin.horse-type.index') }}">
                                    Horse Type
                                </a>
                            ...
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{ route('admin.horse-pollination.index') }}">
                                    Horse Pollination
                                </a>

                            </div>
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{ route('admin.horse-color.index') }}">
                                    Horse Color
                                </a>
                            </div>

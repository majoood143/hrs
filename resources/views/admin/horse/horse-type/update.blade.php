        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Update Horse Type</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.horse-type.update', $horse_type->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <div class="mb-3">
                                <label class="form-label">EN Name</label>
                                <input type="text" class="form-control" name="en_name" value="{{ $horse_type->en_name }}" placeholder="Enter English Name">
                                <x-input-error :messages="$errors->get('en_name')" class="mt-2" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label">AR Name</label>
                                <input type="text" class="form-control" name="ar_name" value="{{ $horse_type->ar_name }}" placeholder="Enter Arabic Name">
                                <x-input-error :messages="$errors->get('en_name')" class="mt-2" />
                            </div>
                            <div class="mb-3">

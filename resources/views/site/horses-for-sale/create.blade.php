                ...
                <div class="mt-5 grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <label class="mt-2 flex cursor-pointer items-center gap-2 text-sm text-warm-800">
                            ...
                            <span class="font-semibold">{{ __('horses-for-sale.price_negotiable') }}</span>
                            <span class="text-xs text-warm-900/50">{{ __('horses-for-sale.price_negotiable_hint') }}</span>
                        </label>
                    </div>
                    <div>
                ...
                <dl class="mt-5 divide-y divide-warm-200 overflow-hidden rounded-2xl border border-warm-200 bg-white text-sm">
                    ...
                    <div class="flex items-center justify-between px-5 py-3">
                        ...
                        <dd class="flex items-center gap-1 font-semibold text-warm-900">
                            ...
                            <span data-review-negotiable class="hidden ms-1 rounded-full bg-sky-100 px-2 py-0.5 text-[11px] font-bold uppercase tracking-wide text-sky-700">{{ __('horses-for-sale.price_negotiable') }}</span>
                        </dd>
                    </div>
                    <div class="flex items-center justify-between px-5 py-3">

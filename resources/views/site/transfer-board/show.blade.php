    ...
    <div class="mx-auto max-w-5xl px-6 py-14">
        ...
        <div class="mt-8 grid gap-10 lg:grid-cols-3">
            <div class="lg:col-span-2">
                <span class="inline-block rounded-full px-3 py-1 text-xs font-bold uppercase tracking-wide {{ $post->type === 'offer' ? 'bg-emerald-100 text-emerald-700' : 'bg-blue-100 text-blue-700' }}">

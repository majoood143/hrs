@php
    $heading = \App\Support\Localized::value($data, 'heading') ?: __('racing.widget.title');
    $subheading = \App\Support\Localized::value($data, 'subheading') ?: __('racing.widget.subtitle');
@endphp

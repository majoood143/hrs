...
return [
     ...
     */
    // 'account' documents the customer sign-in/orders web flow as it actually behaves today
    // (session-cookie auth, redirects, Blade views) — not a JSON contract, just a record of
    // the existing pages. See CLAUDE.md's paid service orders section for the real design.
    'api_path' => ['include' => ['api', 'account']],
